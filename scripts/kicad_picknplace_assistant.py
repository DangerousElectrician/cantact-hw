#!/usr/bin/python2
#https://gist.github.com/pwuertz/152f15b2dadca9a74039aeab944714af
import re
import os
import numpy as np
import pcbnew
...
def create_board_figure(pcb, bom_row, layer=pcbnew.F_Cu):
    ...
    plt.figure(figsize=((8.2,5.8))) #5.8, 8.2))
    ...
    for m in pcb.GetModules():
        ...
        if highlight:
            ...
            mpos =  np.asarray(m.GetPosition()) * 1e-6 # add part reference to highlighted pads
            ax.annotate(m.GetReference(), xy=mpos, horizontalalignment='center', verticalalignment='center', fontsize=5)
